...
- [EXAMPLE_MOVEMENT.md](EXAMPLE_MOVEMENT.md) — tutorial legado (conceito ainda válido)

Ao adicionar feature que afete modders, atualize **MODDING.md**.  
Ao mudar pastas, atualize **ORGANIZED_STRUCTURE.md**.
