# Demonstra marcador de destino pulsante e partículas
...
Take-Shot "C:\dev\cursor\ModularGameEngine\visual_marcador.png"

Start-Sleep -Milliseconds 1500
Take-Shot "C:\dev\cursor\ModularGameEngine\visual_particulas.png"

Write-Output "OK: 2 screenshots capturados"
